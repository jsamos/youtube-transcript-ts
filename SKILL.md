...
Extract transcripts from YouTube videos using a TypeScript implementation that emulates the Python `youtube-transcript-api` (Innertube API + timed XML). No third-party transcript packages; Node.js 18+ and TypeScript only.
